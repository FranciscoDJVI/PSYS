...
router_products_all = DefaultRouter()
# endpoint for alls products for request the client.
router_products_all.register(r"prods", ProductAllAPIView)
...
urlpatterns = [
    ...
    path("", include(router_products_all.urls)),
