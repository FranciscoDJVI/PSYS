...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Sell',
            fields=[
                ('sell_id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='sell',
            name='products',
            field=models.ManyToManyField(related_name='sells', through='api.SellItem', to='api.product'),
        ),
    ]
